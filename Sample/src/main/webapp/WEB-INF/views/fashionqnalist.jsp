...
<html>
  ...
  <body>
    <!-- 상단 바 -->
     <header>
      ...
      <nav class="shop-nav__info">
    	...
    	<a href="login?returnUrl=fashionqnalist">Login</a>
      </nav>
      </c:if>
      <c:if test="${membervo.user_id != null}">
      <nav class="shop-nav__info">
    ...
    <div>
      <div class="box">
        <a href="fashionlist">계절 유행 STYLE</a><br /><br />
        <a href="fashionqnalist" id="selected">게시판</a>
      </div>
          ...
          <div class="search__box--cotainer">
			...
			<c:if test="${empty membervo.user_id}">
			    ...
			    function redirectToLoginPage() {
			        ...
			        var returnUrl = 'fashionqnainsert';
			...
			<c:if test="${not empty membervo.user_id}">
			    <script>
			        function redirectToInsertPage() {
			            window.location.href = 'fashionqnainsert';
			        }
			    </script>
...
//     }
 ...
 $(document).ready(function() {
    ...
    function goSearch(){
    	...
    	let newUrl = "<c:url value='/fashionqnalist'/>?code=" + code + "&search=" + search;
